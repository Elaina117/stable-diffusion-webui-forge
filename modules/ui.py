...
def create_ui():
    ...
    with gr.Blocks(theme=shared.gradio_theme, analytics_enabled=False, title="Stable Diffusion", head=canvas_head) as demo:
        ...
        footer = footer.format(versions=versions_html(), api_docs="/docs" if shared.cmd_opts.api else "https://github.com/AUTOMATIC1111/stable-diffusion-wui/wiki/API")
...
def versions_html():
    ...
    return f"""
version: <a href="https://github.com/lllyasviel/stable-diffusion-wui-forge/commit/{commit}">{tag}</a>
&#x2000;•&#x2000;
...
def setup_ui_api(app):
    ...
    app.mount("/wui-assets", fastapi.staticfiles.StaticFiles(directory=launch_utils.repo_dir('stable-diffusion-wui-assets')), name="wui-assets")
