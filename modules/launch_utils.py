...
{"Alternatively, use a binary release of WebUI: https://github.com/AUTOMATIC1111/stable-diffusion-wui/releases/tag/v1.0.0-pre" if is_windows else ""}
...
def prepare_environment():
    ...
    assets_repo = os.environ.get('ASSETS_REPO', "https://github.com/Elaina117/sd-wui-assets.git")
    ...
    google_blockly_commit_hash = os.environ.get('GOOGLE_BLOCKLY_COMMIT_HASH', "d9f9145fc4f368c80702b134c63659c7949e6541")
    ...
    if not args.skip_torch_cuda_test and not check_run_python("import torch; assert torch.cuda.is_available()"):
        raise RuntimeError(
            ...
            'https://github.com/lllyasviel/stable-diffusion-web'+'ui-forge/releases/tag/latest'
    ...
    git_clone(assets_repo, repo_dir('sd-wui-assets'), "assets", assets_commit_hash)
